  ...
  <footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45 mt-5">
      ...
      <div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
        ...
        <div>
          <p class="s-text7 w-size27">
            Ada Pertanyaa? kirim kami pesan agar kami tau apa yang kurang dari kami msaririzki12@gmail.com
          </p>
    ...
    <div class="t-center s-text8 p-t-20">
      Copyright © 2025 All rights reserved. | This aplication <i class="fa fa-heart-o" aria-hidden="true"></i> by <a
        href="<?= base_url('assets/Template/view_Front-end/')?>https://colorlib.com" target="_blank">RPL Ilkom A</a>
    </div>
    </div>
  </footer>
