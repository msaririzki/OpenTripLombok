...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Bree+Serif|Cabin:400,400i,500,500i,600,600i,700,700i&display=swap"
    rel="stylesheet">
  <!--===============================================================================================-->
...
<div class="container">
    ...
    <main>
      <div class="section-success d-flex align-items-center">
        <div class="col text-center">
          <img src="<?= base_url('assets/images/illuslator/')?>email-send.png" alt="" />
          <h1>Yay! Berhasil</h1>
          <p>
            Temukan paket lain dengan lebih mudah cepat
          </p>
          <a href="<?= base_url('HalUtama')?>" class="btn btn-home-page mt-3 px-5">Kembali</a>
        </div>
      </div>
  <!-- Footer -->
  <footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45 mt-5">
    ...
    <div class="t-center s-text8 p-t-20">
      Copyright © 2005 All rights reserved. | This aplication <i class="fa fa-heart-o" aria-hidden="true"></i> by <a
        href="<?= base_url('assets/Template/view_Front-end/')?>https://colorlib.com" target="_blank">Mu</a>
    </div>
    </div>
  </footer>
